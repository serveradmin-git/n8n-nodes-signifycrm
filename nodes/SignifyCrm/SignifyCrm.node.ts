                ...
                if (resource === 'account') {
                    ...
                    if (operation === 'create') {
                        ...
                        const nameValueList: Array<{ name: string; value: string }> = [
                            { name: 'Assigned_user_id'.toLowerCase(), value: assignedUser || currentUserId },
                            { name: 'Name'.toLowerCase(),             value: name         },
                            { name: 'Account_type'.toLowerCase(),     value: accountType  },
                            { name: 'Industry'.toLowerCase(),         value: industry     },
                            { name: 'Status'.toLowerCase(),           value: status       },
                        ];
                        ...
                        const nameValueList = [
                            { name: 'ID'.toLowerCase(),      value: accountId },
                            { name: 'Deleted'.toLowerCase(), value: '1'         },
                        ];
                    ...
                    if (operation === 'create') {
                        ...
                        const nameValueList: Array<{ name: string; value: string; }> = [
                            { name: 'Assigned_user_id'.toLowerCase(), value: userId },
                            { name: 'Salutation'.toLowerCase(), value: salutation },
                            { name: 'First_name'.toLowerCase(), value: firstName },
                        ];
                        ...
                        const nameValueList = [
                            { name: 'ID'.toLowerCase(),      value: contactId },
                            { name: 'Deleted'.toLowerCase(), value: '1'       },
                        ];
                    ...
                    if (operation === 'create') {
                        ...
                        const nameValueList: Array<{ name: string; value: string; }> = [
                            { name: 'Assigned_user_id'.toLowerCase(), value: assignedUser || userId },
                            { name: 'Salutation'.toLowerCase(), value: salutation },
                            { name: 'First_name'.toLowerCase(), value: firstName },
                            { name: 'Status'.toLowerCase(), value: status },
                        ];
                        ...
                        const nameValueList = [
                            { name: 'ID'.toLowerCase(),      value: leadId },
                            { name: 'Deleted'.toLowerCase(), value: '1'       },
                        ];
                    ...
                    if (operation === 'create') {
                        ...
                        const nameValueList: Array<{ name: string; value: string; }> = [
                            { name: 'Assigned_user_id'.toLowerCase(), value: assignedUser || userId },
                            { name: 'Name'.toLowerCase(),             value: name },
                            { name: 'Account_id'.toLowerCase(),       value: accountId },
                            { name: 'Amount'.toLowerCase(),           value: amount },
                            { name: 'Sales_stage'.toLowerCase(),      value: salesStage },
                            { name: 'Date_closed'.toLowerCase(),      value: closeDate },
                            { name: 'Opportunity_type'.toLowerCase(), value: oppType },
                            { name: 'Lead_source'.toLowerCase(),      value: leadSource },
                            { name: 'Currency_id'.toLowerCase(),      value: currencyId },
                        ];
                        ...
                        const nameValueList = [
                            { name: 'ID'.toLowerCase(),      value: opportunityId },
                            { name: 'Deleted'.toLowerCase(), value: '1'       },
                        ];
                    ...
                    if (operation === 'create') {
                        ...
                        const nameValueList: Array<{ name: string; value: string; }> = [
                            { name: 'Assigned_user_id'.toLowerCase(), value: assignedUser || userId },
                            { name: 'Subject'.toLowerCase(),          value: subject      },
                            { name: 'Account_id'.toLowerCase(),       value: accountId    },
                            { name: 'Status'.toLowerCase(),           value: status       },
                            { name: 'Type'.toLowerCase(),             value: caseType     },
                            { name: 'Request_date'.toLowerCase(),     value: reqDate      },
                            { name: 'Due_date'.toLowerCase(),         value: dueDate      },
                        ];
                        ...
                        const nameValueList = [
                            { name: 'ID'.toLowerCase(),      value: caseId },
                            { name: 'Deleted'.toLowerCase(), value: '1'       },
                        ];
                    ...
                    if (operation === 'create') {
                        ...
                        const nameValueList: Array<{ name: string; value: string; }> = [
                            { name: 'Assigned_user_id'.toLowerCase(), value: assignedUser || userId },
                            { name: 'Name'.toLowerCase(),             value: subject  },
                            { name: 'Status'.toLowerCase(),           value: status   },
                            { name: 'Priority'.toLowerCase(),         value: priority },
                            { name: 'Date_start'.toLowerCase(),       value: startDate },
                            { name: 'Date_due'.toLowerCase(),         value: dueDate   },
                        ...
                        const nameValueList = [
                            { name: 'ID'.toLowerCase(),      value: taskId },
                            { name: 'Deleted'.toLowerCase(), value: '1'       },
                        ];
